...
You can generate a full text guide showing the helpful messages
generated by running each step of the tutorial.  This is useful
to print or have open while you run the tutorial so you can see
